...
call append( s:currentLineNum, s:currentName . ".search_code_name_list := (\"ISIN\");" )
call append( s:currentLineNum, s:currentName . ".search_code_value := \"<@ISIN_SEARCHED@>\";" )
