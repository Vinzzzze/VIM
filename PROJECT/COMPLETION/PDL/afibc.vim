...
call append( s:currentLineNum, s:currentName . ".search_code_name_list := (\"<@RIC_ISIN_SEDOL@>\");" )
call append( s:currentLineNum, s:currentName . ".search_code_value := \"<@CODE_SEARCHED@>\";" )
