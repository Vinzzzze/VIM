" Fichier : DELETE.vim
"
" But : How the DELETE command had to be completed.
"
...
call setline( s:currentLineNum, s:currentLine . " FROM" )
...
call append( s:currentLineNum, s:currentIndent . "USING" )
call append( s:currentLineNum, s:currentIndent . g:SQL_projectIndentation . "<@TABLE_TO_DELETE@>" )
